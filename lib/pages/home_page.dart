...
class _HomePageState extends State<HomePage> {
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    selectedType == 0
                        ? buildDesktopPasswordUI(theme)
                        : buildDesktopPassphraseUI(theme),
                  ],
                ),
              ),
            ],
  ...
  // Password UI section, fully theme-adaptive
  Widget buildDesktopPasswordUI(ThemeData theme) {
    return Row(
      children: [
        // Left Half / Main Page
        Expanded(
        ...
        // Right Half / Settings page
        Expanded(flex: 1, child: Column(children: [const Text('H')])),
      ],
    );
  }

  // Passphrase UI section, fully theme-adaptive
  Widget buildDesktopPassphraseUI(ThemeData theme) {
    return Row(
      children: [
        Expanded(
          flex: 1,
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Expanded(
                        flex: 1,
                        child: Column(children: [const Text('H')]),
                      ),
                    ],
                  ),
                ),
